...
![](https://pg12138.oss-cn-beijing.aliyuncs.com/assets/in-post/2020-2-4/2019-12-31-16-29-21.png)

当我们删除文件时，删除的实际上是指针，因此，无论删除多么大的文件，速度都非常快。

![](https://pg12138.oss-cn-beijing.aliyuncs.com/assets/in-post/2020-2-4/2019-12-31-16-29-43.png)

2. **文件的拷贝**

如果你复制一个文件，是将该文件指针指向的内容进行复制，然后产生一个新文件指向新的内容

![](https://pg12138.oss-cn-beijing.aliyuncs.com/assets/in-post/2020-2-4/2019-12-31-16-30-25.png)

3. **硬链接 hard link**

硬链接的概念来自于 Unix 操作系统，它是指将一个文件A指针复制到另一个文件B指针中，文件B就是文件A的硬链接

![](https://pg12138.oss-cn-beijing.aliyuncs.com/assets/in-post/2020-2-4/2019-12-31-16-33-59.png)
...
![](https://pg12138.oss-cn-beijing.aliyuncs.com/assets/in-post/2020-2-4/2019-12-31-16-46-57.png)
...
![](https://pg12138.oss-cn-beijing.aliyuncs.com/assets/in-post/2020-2-4/2019-12-31-17-50-59.png)
...
![](https://pg12138.oss-cn-beijing.aliyuncs.com/assets/in-post/2020-2-4/2019-12-31-18-09-53.png)

4. 从缓存的对应包中使用硬链接放置文件到相应包代码目录中

![](https://pg12138.oss-cn-beijing.aliyuncs.com/assets/in-post/2020-2-4/2019-12-31-18-14-31.png)

5. 使用符号链接，将每个包的**直接依赖**放置到自己的目录中

![](https://pg12138.oss-cn-beijing.aliyuncs.com/assets/in-post/2020-2-4/2019-12-31-18-19-48.png)
...
![](https://pg12138.oss-cn-beijing.aliyuncs.com/assets/in-post/2020-2-4/2019-12-31-18-27-19.png)
